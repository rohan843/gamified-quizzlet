        ...
        <div className="bg-black bg-opacity-80 text-white h-screen flex justify-center z-50 fixed top-0 left-0 w-full h-full">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M26.657 11.343a1 1 0 010 1.414L20.414 19l6.243 6.243a1 1 0 11-1.414 1.414L19 20.414l-6.243 6.243a1 1 0 01-1.414-1.414L17.586 19l-6.243-6.243a1 1 0 011.414-1.414L19 17.586l6.243-6.243a1 1 0 011.414 0z"
                fill="#FFF"
              />
            </svg>
          </div>
          ...
          <div className="bg-[#FFBF00] border border-[#D05F20] rounded-[24px] border-8 max-w-[800px] max-h-[500px] mt-[10vh]">
            <div className="flex justify-center">
              <img
                ...
                alt="IMAGE"
                className="max-h-[100px] max-w-[100px] mt-4"
              ></img>
            </div>
            <div className="text-[#900101] text-center text-[100px]">
              NEW FLASHCARD DISCOVERED!!!
            </div>
          </div>
        </div>
      )}
